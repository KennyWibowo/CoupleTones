...
public class CcsClient {
    ...
    private String mApiKey = "AIzaSyABs44C95ZRlEqox6UVhOxfOFkAtv941F4";
    ...
    public void handleIncomingDataMessage(CcsMessage msg) {
        if (msg.getPayload().get("action") != null) {
            System.out.println("handleIncomingDataMessage");
    ...
    public static Map createAttributeMap(String to, String messageId, Map<String, String> payload,
        ...
        System.out.println("createAttributeMap: Sending to: " + to);
    ...
    public void connect() throws XMPPException {
        ...
        connection.addPacketListener(packet -> {
            ...
            System.out.println("packetListener(xml): " + packet.toXML());
            Message incomingMessage = (Message) packet;
            GcmPacketExtension gcmPacket
                    = (GcmPacketExtension) incomingMessage.getExtension(GCM_NAMESPACE);
            String json = gcmPacket.getJson();
            System.out.println("packetListener (json): " + json);
            try {
                @SuppressWarnings("unchecked")
    ...
    private void handleMessage(Map<String, Object> jsonMap) {
        ...
        if (messageType == null) {
            ...
            try {
                ...
                /*CcsClient ccsClient = getInstance();

                String toRegId = msg.getPayload().get("toRegId");
                String message_title = msg.getPayload().get("title");
                String message_content = msg.getPayload().get("content");


                String messageId = ccsClient.getRandomMessageId();
                Map<String, String> payload = new HashMap<String, String>();
                payload.put("title", message_title);
                payload.put("content", message_content);
                String collapseKey = "sample";
                Long timeToLive = 10000L;
                Boolean delayWhileIdle = true;
                List<String> list = new ArrayList<String>();
                list.add(toRegId);
                ccsClient.sendBroadcast(payload, collapseKey, timeToLive, true, list );*/
                        /*createJsonMessage(toRegId, messageId, payload, collapseKey,
                        timeToLive, delayWhileIdle));*/
    ...
    public static void main(String[] args) {
        final String projectId = "366742322722";
    ...
    public static Content createContent(CcsMessage msg) {
        ...
        String toRegId = msg.getPayload().get("to");
        String message_title = msg.getPayload().get("title");
        String message_content = msg.getPayload().get("content");

        c.addRegId(toRegId);
        c.createData(message_title, message_content);
